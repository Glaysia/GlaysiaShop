 ...
 * @since 0.5.0
 */
public class MyLabel_v2 extends OutlinePane {
     ...
     * @see #MyLabel_v2(int, int, int, int, Priority, Font)
     * @since 0.10.8
     */
    public MyLabel_v2(@NotNull Slot slot, int length, int height, @NotNull Priority priority, @NotNull Font font,
     ...
     * @since 0.10.8
     */
    public MyLabel_v2(int x, int y, int length, int height, @NotNull Priority priority, @NotNull Font font,
                      @NotNull Plugin plugin) {
     ...
     * @param font the character set
     * @param plugin the plugin that will be the owner for this label's items
     * @see #MyLabel_v2(int, int, int, int, Font)
     * @since 0.10.8
     */
    public MyLabel_v2(@NotNull Slot slot, int length, int height, @NotNull Font font, @NotNull Plugin plugin) {
     ...
     * @since 0.10.8
     */
    public MyLabel_v2(int x, int y, int length, int height, @NotNull Font font, @NotNull Plugin plugin) {
     ...
     * @param font the character set
     * @param plugin the plugin that will be the owner for this label's items
     * @see #MyLabel_v2(int, int, Font)
     * @since 0.10.8
     */
    public MyLabel_v2(int length, int height, @NotNull Font font, @NotNull Plugin plugin) {
     ...
     */
    public MyLabel_v2(@NotNull Slot slot, int length, int height, @NotNull Priority priority, @NotNull Font font) {
        this(slot, length, height, priority, font, JavaPlugin.getProvidingPlugin(MyLabel_v2.class));
    }
     ...
     */
    public MyLabel_v2(int x, int y, int length, int height, @NotNull Priority priority, @NotNull Font font) {
        this(x, y, length, height, priority, font, JavaPlugin.getProvidingPlugin(MyLabel_v2.class));
    }
     ...
     * @since 0.10.8
     */
    public MyLabel_v2(@NotNull Slot slot, int length, int height, @NotNull Font font) {
     ...
     * @since 0.5.0
     */
    public MyLabel_v2(int x, int y, int length, int height, @NotNull Font font) {
     ...
     * @since 0.5.0
     */
    public MyLabel_v2(int length, int height, @NotNull Font font) {
    ...
    public void setText(String itemMeta, @NotNull String text,
                        @NotNull BiFunction<? super @NotNull Character, ? super @NotNull ItemStack,
                                ? extends @NotNull GuiItem> processor) {
        this.text = text;
        ItemMeta iItemMeta;
        ...
        for (char character : text.toCharArray()) {
            ...
            iItemMeta = item.getItemMeta();
            iItemMeta.setDisplayName(itemMeta);
            item.setItemMeta(iItemMeta);
            addItem(processor.apply(character, item.clone()));
        }
    }
    ...
    @Contract(pure = true)
    @Override
    public MyLabel_v2 copy() {
        MyLabel_v2 label = new MyLabel_v2(getSlot(), length, height, getPriority(), font, this.plugin);
    ...
    @NotNull
    @Contract(pure = true)
    public static MyLabel_v2 load(@NotNull Object instance, @NotNull Element element, @NotNull Plugin plugin) {
        int length;
        int height;
        ...
        MyLabel_v2 label = new MyLabel_v2(length, height, font, plugin);
