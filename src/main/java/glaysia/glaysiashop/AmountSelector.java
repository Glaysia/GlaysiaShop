...
public class AmountSelector implements CommandExecutor {
    ...
    public static boolean isNotTrading(){
        ...
        if(itemPaletteGUI==null){
            return pageGUI.getViewers().size()==0;
        }
...
//            askGui=new MyChestGui("거래요청 창§8 R");
//
////            item.setItemMeta()
//
...
//                        askOrderBookGui = new MyChestGui("호가§8§lO§r창, 우클릭 거래");
//                        setGuiToOrderBook();
...
//                        myOrderListGui = new MyChestGui("내 거래목록 §8§lM§r창 좌 정보출력, 우 거래취소");
//                        setOrderList();;
