...
//
//public class GlaysiaTrade extends JavaPlugin{
...
//
//
//    GlaysiaTrade(double price, int amount, String trader, Material material, boolean was_there_error){
...
//        }
//
//        GlaysiaTrade.order_id++; //거래할 때마다 증가. static변수를 사용.
//
//        Map<String, Object> sheet = new HashMap<>();
//
//        Order order = new Order(
//                GlaysiaTrade.order_id,
//                (new Date()),
//                price,
//                amount,
//                trader,
...
//        );
//
//        sheet.put(String.valueOf(GlaysiaTrade.order_id), order);
//
